...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {// central dispatch
	// global.RiotControl = require('./riotcontrol.js')
	// global.api = require('./appstore.js')
	// RiotControl.addStore(api) // Register the store in central dispatch
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('integer', '<input type="{\'number\'}" name="{opts.name}">', '', '', function(opts) {
	}, '{ }');

	riot.tag2('decimal', '<input type="{\'number\'}" step="0.01" name="{opts.name}">', '', '', function(opts) {
	}, '{ }');

	riot.tag2('string', '<input type="text" name="{opts.name}">', '', '', function(opts) {
	}, '{ }');

	riot.tag2('choose', '<select name="{opts.name}"> <option value="1">One</option> <option value="2">Two</option> <option value="3">Three</option> </select>', '', '', function(opts) {
	}, '{ }');
	...
	riot.tag2('app', 'name: <input id="fieldName">&nbsp; type: <select id="inputType"> <option value="integer">Integer</option> <option value="decimal">Decimal</option> <option value="string">String</option> <option value="choose">Select</option> </select> <button onclick="{add}">Add</button> <h3>Inputs</h3> <div each="{inp in inputs}"> <div class="row"> <div class="label">{inp.name || inp.tag}:</div> <raw content="{inp}"></raw> <div class="remove" onclick="{parent.remove}">x</div> </div> </div>', '', '', function(opts) {
	    this.inputs = []
